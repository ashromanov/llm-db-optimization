...
ANALYZE_SCHEMA = (
    ...
    "INPUT QUERIES (sorted by impact: runquantity × executiontime):\n{input_queries}\n\n"
    "Your Task:\n"
    ...
    "   - List existing indexes and constraints\n"
    "   - Note any obvious inefficiencies (e.g., missing indexes, suboptimal types)\n\n"
    "2. QUERY PATTERN ANALYSIS:\n"
    "   - Analyze the top 10 most impactful queries\n"
    "   - Identify common JOIN patterns, WHERE clause filters, GROUP BY operations\n"
    "   - Detect potential N+1 queries or missing indexes\n"
    "   - Find opportunities for materialized views or computed columns\n\n"
    "3. OPTIMIZATION RECOMMENDATIONS:\n"
    "   - Suggest specific indexes (on which tables and columns)\n"
...
DEVELOP_DDL_FROM_PLAN = (
    ...
    "CRITICAL: ALL tables MUST be created with format = 'ICEBERG'\n\n"
    ...
    "- Add appropriate constraints (PRIMARY KEY, FOREIGN KEY, NOT NULL, etc.)\n"
    "- Preserve all data columns (do not lose information)\n"
    "- Use meaningful names for indexes: idx_<table>_<columns>\n"
    "- Use meaningful names for materialized views: mv_<purpose>\n\n"
...
DEVELOP_MIGRATIONS_FROM_PLAN = (
    ...
    "[NEW_DDL_END]\n\n"
    "Your Task:\n"
    "Generate idempotent SQL migration commands to safely transform OLD schema into NEW schema.\n\n"
    ...
    "- Add constraints LAST (after all data and indexes)\n"
    ...
    "CREATE INDEX idx_users_new_name ON users_new(name);\n\n"
    "WRONG EXAMPLE (DO NOT DO THIS):\n"
