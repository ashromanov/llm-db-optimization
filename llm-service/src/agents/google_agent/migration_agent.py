...
from .prompts import DEVELOP_MIGRATIONS_FROM_PLAN
...
class MigrationAgent:
    ...
    def __init__(self, google_api_key: str, temperature: float = 0.0):
        ...
        Args:
            ...
            temperature (float): Sampling temperature (0.0 for deterministic SQL generation).
        """
    ...
    async def generate_migrations(
        ...
        Args:
            ...
            old_ddl_statements (list[str]): Original DDL statements.
            new_ddl_statements (list[str]): New optimized DDL statements.
        ...
        print(
            f"[MigrationAgent] ✓ Generated {len(migration_statements)} migration statements"
        )
